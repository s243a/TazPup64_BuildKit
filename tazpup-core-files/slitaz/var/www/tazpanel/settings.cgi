...
for i in audio cdrom video tty plugdev disk lp scanner dialout camera operator tape; do addgroup $users $i; done
passwd -u $users | log
fi;;
calendar)
...
<!-- $(_ 'Selection:') -->
<button name="do" value="delgroups" data-icon="">$(_ 'Delete group')</button>
</header>
<div class="scroll">
...
<label for="$group" data-icon="">$group</label></td>
<td>$3</td>
<td>${4//,/, }</td>
</tr>
EOT
...
<button type="submit" name="do" value="addgroup" data-icon="">$(_ 'Create group')</button>
</footer>
</form>
</section>
<section>
...
<footer>
<button name="do" value="addmember" data-icon="">$(_ 'Add user')</button>
<button name="do" value="delmember" data-icon="">$(_ 'Remove user')</button>
</footer>
</form>
</section>
EOT
...
<header>
<!--$(_ 'Selection:')-->
<button name="do" value="delusers"    data-icon="">$(_ 'Delete user')</button>
<button name="do" value="lockusers"   data-icon="">$(_ 'Lock user')</button>
<button name="do" value="unlockusers" data-icon="">$(_ 'Unlock user')</button>
</header>
...
<button type="submit" name="do" value="chpasswd" data-icon="">$(_ 'Change password')</button>
</footer>
</form>
</section>
<section>
...
<footer>
<button type="submit" name="do" value="adduser" data-icon="">$(_ 'Create user')</button>
</footer>
</form>
</section>
EOT
...
<footer>
<button type="submit" data-icon="">$(_ 'Activate')</button>
</footer>
</form>
</section>
EOT
...
<p>$(_ 'Manual edit: %s' "<a data-icon=\"\" href="index.cgi?file=$HOME/.profile">~/.profile</a>")<br/>
...
<p>$(_ 'Manual edit: %s' \
"<a data-icon=\"\" href=\"index.cgi?file=$HOME/.local/share/desktop-directories/SliTazMenu.directory\">~/.local/share/desktop-directories/SliTazMenu.directory</a>
$(
find $HOME/.config/lxpanel -type f -name panel | awk -vh="$HOME" \
'{ printf "<a data-icon=\"\" href=\"index.cgi?file=%s\">%s</a> ", $1, gensub(h, "~", "")}'
)")</p>
</fieldset>
</div>
</section>
...
cat <<EOT
<form><!--
--><button name="users"  data-icon="">$(_ 'Manage users')</button><!--
--><button name="groups" data-icon="">$(_ 'Manage groups')</button>
</form>
<section>
...
<span id="dateTime" data-icon="">$(date +%x)<span style="display:none">$(date +%F)</span></span>
</button>
EOT
fi
cat <<EOT
...
if [ -z "$(which yad)" ]; then
cat <<EOT
<button name="do" value="date" data-icon="">$(_ 'Set date')</button>
EOT
else
cat <<EOT
<button data-icon="" onclick="submitSysTimeForm()">$(_ 'Set date')</button>
EOT
fi
cat <<EOT
</fieldset>
...
<button name="locale" data-icon="">$(_ 'Change')</button>
EOT
fi
cat <<EOT
</div>
...
<button form="settings" name="apply_xorg_kbd" value="$keymap" data-icon="">$(_ 'Activate')</button>
<button form="index" name="file" value="$keyboard_config" data-icon="">$(_ 'Edit')</button>
...
<button data-icon="">$(_ 'Activate')</button>
</fieldset>
</form>
<fieldset><legend>$(_ 'Configuration files:')</legend>
<button form="index" name="file" value="$CONFIG" data-icon="">$(_ 'Panel')</button>
<button form="index" name="file" value="$HTTPD_CONF" data-icon="">$(_ 'Server')</button>
</fieldset>
