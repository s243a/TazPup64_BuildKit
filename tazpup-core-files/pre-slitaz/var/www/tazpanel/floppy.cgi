...
cat <<EOT
<li><a data-icon="" href="floppy.cgi">$(_ 'Boot floppy')</a></li>
EOT
...
<div>
<button type="submit" name="doformat" data-icon="">$(_ 'Format disk')</button>
...
<tr>
<td>
<button type="submit" name="write" data-icon="">$(_ 'Write image')</button>
$(listfd tofd) &lt;&lt;&lt; <input name="fromimage" type="file">
</td>
</tr>
<tr>
<td>
<button type="submit" name="read" data-icon="">$(_ 'Read image')</button>
...
<button type="submit" name="build" data-icon="">$(_ 'Build floppy set')</button>
</td>
</tr>
</table>
<footer>
...
<td><button type="submit" name="build" data-icon="">
